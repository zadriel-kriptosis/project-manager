<footer
    class="p-4 my-6 mx-4 bg-white rounded-3xl shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-diesel-900">
...
<p class="my-10 text-sm text-center text-gray-400">
    &copy; {{date('Y')}} |  <a href="{{route('home')}}" class="hover:underline"
                        target="_blank">{{ Cache::tags('Settings')->get('app_url') }}</a>. {{ Cache::tags('Settings')->get('app_footertext') }}
</p>
