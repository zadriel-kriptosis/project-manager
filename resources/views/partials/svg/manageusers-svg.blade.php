<svg
    class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white {{ request()->routeIs('admin.role.*') || request()->routeIs('admin.user.*') ? 'text-gray-950 dark:text-white' : '' }}"
    fill="currentColor" viewBox="0 96 960 960" xmlns="http://www.w3.org/2000/svg">
    <path
