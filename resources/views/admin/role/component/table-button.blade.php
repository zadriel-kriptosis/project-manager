...
<div class="flex flex-row gap-2">
    @can($model . '-edit')
        <a href="{{ route('admin.' . $model . '.edit', ['uuid' => $data->uuid]) }}" title="@lang('admin.edit_data')">
    ...
    @endcan
        @can($model . '-destroy')
            <a href="#deleteModal{{ $data->uuid }}" title="@lang('admin.destroy_data')">
            ...
            <!-- Modal -->
            <div id="deleteModal{{ $data->uuid }}" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity duration-300">
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 w-11/12 md:w-1/3">
                    ...
                    <div class="flex justify-end">
                        <a href="#" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded mr-2">@lang('admin.cancel')</a>
                        <a href="{{ route('admin.' . $model . '.destroy', ['uuid' => $data->uuid]) }}"
