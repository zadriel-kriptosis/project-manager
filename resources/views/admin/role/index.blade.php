            ...
            <div class="flex-grow overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">@lang('admin.role_slug')</th>
                    ...
                    @foreach($datas as $data)
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-300">
                            <td class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">{{ $data->uuid }}</td>
                            <td class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">@lang('roles.' . $data->name)</td>
                            <td class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">{{ $data->name }}</td>
                            <td class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                @include('admin.' . $model . '.component.table-button', ['model' => $model, 'data' => $data])
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
